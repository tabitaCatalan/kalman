...
function update_real_state!(ms::Measurements, updater::KalmanUpdater, control, error)
...
function update_real_state!(system::InnerState, updater::KalmanUpdater, control, error)
    new_state = update_inner_system(updater, get_inner_state(system), control, error)
